...
- [Aura resize deadline](research/2026-09-24/aura-resize-deadline.md): Windows and
  Linux also embed a resized page with a deadline of 0, so the switch alone
  does nothing there; the same content APIs would make a resize wait.
