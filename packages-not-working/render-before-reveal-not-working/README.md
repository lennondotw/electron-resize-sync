...
Render before reveal in the [resize sync plan](../../docs/plans/2026-09-24/resize-sync.md):
...
- 127 ms per step at 30 ms of busy work, against 64 ms for resize deadline.
