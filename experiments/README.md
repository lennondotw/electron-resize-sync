...
| ------------------------------------------------ | ------------------------------------------------------------------------ | ----------------------------------------------------------------- |
| [resize-pacing](resize-pacing/README.md)         | How long does a new window size stay unpainted, with and without pacing? | [2026-09-24](../docs/experiments/2026-09-24/resize-pacing.md)     |
