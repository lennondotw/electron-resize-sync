...
// node_modules is never modified. No symbols needed: the package patches the
// build from its table (see find-sites.ts to add a build). See README.md.
...
await patchElectronFramework({ appPath, log: console.log });
